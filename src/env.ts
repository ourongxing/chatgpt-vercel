...
export const defaultEnv = {
  ...
  - 如果本站对你有所帮助，可以给Ai [买点零食](https://yuboliu.notion.site/d754559533764f9b8ae50275553179fb)，但不接受任何付费功能请求。
  - 点击每条消息前的头像，可以锁定对话，作为角色设定。[查看更多使用技巧](https://yuboliu.notion.site/AI-d1f94c0769944d219f91fb2363b12a06)。
