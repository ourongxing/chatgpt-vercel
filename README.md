...
不过上面这种方式不容易更新，最好还是先 fork 本仓库，然后在 [Vercel](https://vercel.com/new) 中导入你自己的仓库，之后要更新就在 Github 里点击 `Sync fork` 就可以同步更新了。

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/repository-url=https://github.com/ourongxing/chatgpt-vercel&env=OPENAI_API_KEY)
